  ...
  <div class="scene">
    <div class="box">
      <div class="box__face box__face--front">
        <section>
          ...
          <div class="banny__container">
            <img id="banny" src="$lib/assets/characters/15.png" alt="Banny" />
          </div>
        </section>
      </div>
      <div class="box__face box__face--back">
        <section>
          <header>
            <!-- <img class="logo" src="./assets/logo.png" alt="BannyVerse Logo" /> -->
            <svg
              id="wifi"
              xmlns="http://www.w3.org/2000/svg"
              width="22"
          ...
          <img class="logo" src="$lib/assets/logo.png" alt="BannyVerse Logo" />
        </section>
      </div>
